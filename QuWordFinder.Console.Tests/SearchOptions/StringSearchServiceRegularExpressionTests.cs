...
public class StringSearchServiceRegularExpressionTests
{
    ...
    [Fact]
    public void Should_SearchByRegularExpressionParallel_Search_Values()
    {
    ...
    [Fact]
    public void Should_SearchByRegularExpressionTask_Search_Values()
    {
    ...
    [Fact]
    public void Should_SearchByRegularExpressionForEach_Search_Values()
    {
