...
public class StringSearchServiceIndexTests
{
    ...
    [Fact]
    public void Should_SearchByIndexTask_Search_Values()
    {
    ...
    [Fact]
    public void Should_SearchBySearchByIndexParallel_Search_Values()
    {
    ...
    [Fact]
    public void Should_SearchByIndexForEach_Search_Values()
    {
